      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <a href="mailto:nuthipranav@gmail.com" className="flex items-center gap-4 text-lg transition-colors hover:text-accent">
           ...
           <div className="flex gap-4 pt-4">
            <Button asChild>
                <a href="https://drive.google.com/file/d/1XZ0XErppVpeLd1de_b-v3yp803J0kB37/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                    <Download className="mr-2 h-4 w-4" /> Download CV
                </a>
            </Button>
          </div>
          <div className="flex gap-4 border-t pt-6 mt-6">
            <Link href="https://github.com/Pranav5543" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <Github className="h-8 w-8 text-muted-foreground transition-colors hover:text-foreground" />
            </Link>
            <Link href="https://www.linkedin.com/in/pranav235" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea placeholder="Hi Pranav, let's connect!" className="min-h-[150px]" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
